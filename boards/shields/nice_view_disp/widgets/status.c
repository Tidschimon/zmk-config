...
static void draw_top(lv_obj_t *widget, lv_color_t cbuf[],
  ...
  init_label_dsc(&label_dsc, LVGL_FOREGROUND, &lv_font_montserrat_16,
                 LV_TEXT_ALIGN_RIGHT);
  lv_draw_labeld_dsc_t label_commit_hash_dsc;
  init_label_dsc(&label_commit_msg_hash, LVGL_FOREGROUND,
                 &lv_font_montserrat_12, LV_TEXT_ALIGN_LEFT);
  lv_draw_labeld_dsc_t label_commit_msg_dsc;
  init_label_dsc(&label_commit_msg_dsc, LVGL_FOREGROUND, &lv_font_montserrat_12,
                 LV_TEXT_ALIGN_LEFT);
  // lv_draw_label_dsc_t label_dsc_wpm;
  // init_label_dsc(&label_dsc_wpm, LVGL_FOREGROUND, &lv_font_unscii_8,
  // LV_TEXT_ALIGN_RIGHT); lv_draw_rect_dsc_t rect_black_dsc;
...
// static void set_wpm_status(struct zmk_widget_status *widget, struct
// wpm_status_state state) {
//     for (int i = 0; i < 9; i++) {
...
#ifdef CONFIG_NICE_VIEW_DISP_ROTATE_180 // sets positions for default and
                                        // flipped canvases
int top_pos = 0;
int middle_pos = 68;
int bottom_pos = 136;
